...
The fish's interior, originally a relatively closed and near-sterile environment, now depends entirely on external conditions to stay stable. This means that if any single step goes wrong, the risk can actually be amplified.
...
The point of this isn't to delay rigor mortis — it's to let the fish lose consciousness quickly through a sharp temperature shock, avoiding the stress buildup from prolonged struggling.

The muscle tension caused by the cold actually helps push blood out more effectively.

Ice killing doesn't delay the onset of rigor mortis, but it noticeably extends the duration of the rigor phase itself, keeping the fish in a structurally stable state for longer.
